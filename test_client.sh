...
./a.out 2345 $host test_patterns/pattern1.txt >> results.txt
sleep $sleep_time
...
sleep $sleep_time
MAX_PATTERN_LENGTH=4 MAX_TEXT_LENGTH=256 make
./a.out 2345 $host test_patterns/pattern4.txt >> results.txt
sleep $sleep_time
MAX_PATTERN_LENGTH=5 MAX_TEXT_LENGTH=256 make
./a.out 2345 $host test_patterns/pattern5.txt >> results.txt
sleep $sleep_time
MAX_PATTERN_LENGTH=8 MAX_TEXT_LENGTH=256 make
./a.out 2345 $host test_patterns/pattern8.txt >> results.txt
sleep $sleep_time
MAX_PATTERN_LENGTH=16 MAX_TEXT_LENGTH=256 make
./a.out 2345 $host test_patterns/pattern16.txt >> results.txt
sleep $sleep_time
MAX_PATTERN_LENGTH=64 MAX_TEXT_LENGTH=256 make
./a.out 2345 $host test_patterns/pattern64.txt >> results.txt
sleep $sleep_time
MAX_PATTERN_LENGTH=128 MAX_TEXT_LENGTH=256 make
./a.out 2345 $host test_patterns/pattern128.txt >> results.txt
